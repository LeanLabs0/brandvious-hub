// ============================================================================
// Zero-Friction CMS — OPTIONAL explicit wrapper. Place at
// `client/src/components/editable.tsx`.
//
// Use this instead of the auto-overlay for copy that must survive refactors.
// The key is a STABLE string you choose (e.g. "home.hero.title"), not a
// DOM-position path, so moving the element in the JSX keeps the saved edit.
//   <Editable id="home.hero.title" defaultValue="Welcome" tag="h1" />
// ============================================================================
