// ============================================================================
// Zero-Friction CMS — OPTIONAL multi-field card editor. Place at
// `client/src/components/editable-card.tsx`. Requires shadcn Button, Input,
// Textarea, Dialog. Edits several stable keys (id.field) behind one pencil.
//
//   <EditableCard id="product.0" fields={[
//     { key: "title", label: "Title", type: "text", defaultValue: "..." },
//     { key: "body",  label: "Body",  type: "textarea", defaultValue: "..." },
//   ]}>
//     {(v) => (<><h3>{v.title}</h3><p>{v.body}</p></>)}
//   </EditableCard>
// ============================================================================
