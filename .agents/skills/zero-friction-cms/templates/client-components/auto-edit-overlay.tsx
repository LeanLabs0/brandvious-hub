 ...
 *
 * NOTE: animated text (constantly re-rendering elements) will get the outline
 * but edits will be overwritten by the next render. Don't expect auto-edit to
 * work for clocks, marquees, animated counters, etc.
 */
