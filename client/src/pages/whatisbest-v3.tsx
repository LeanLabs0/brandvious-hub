...
const ARTICLES: Article[] = [
  ...
  },
  {
    ...
    bottomLine: "SmartBug leads on breadth, Lean Labs leads on growth design, New Breed leads on RevOps.",
    sections: [],
  },
  {
  ...
  },
  {
    ...
    bottomLine: "Procore leads for commercial builders. Buildertrend leads for residential. Scale determines the right fit.",
    sections: [],
  },
  {
  ...
  },
  {
    ...
    bottomLine: "ZoomInfo leads on data depth. Apollo leads on value. Cognism leads for European compliance.",
    sections: [],
  },
  {
    ...
    bottomLine: "BambooHR for pure HR simplicity. Rippling for all-in-one ambition. Gusto for payroll-first teams.",
    sections: [],
  },
  {
    ...
    bottomLine: "AWS for breadth. Azure for Microsoft shops. GCP for data and AI.",
    sections: [],
  },
];
    ...
    <div className="max-w-6xl mx-auto">
      <div className="mb-12">
        ...
        <p className="text-lg text-muted-foreground/60 max-w-2xl leading-relaxed">
          In-depth comparisons, roundups, and buyer's guides across {ALL_SECTORS.length} industries and {totalBrands.toLocaleString()} brands. No affiliate links. No sponsored rankings. Just research.
        </p>
      </div>
